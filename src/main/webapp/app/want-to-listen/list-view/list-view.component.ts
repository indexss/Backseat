...
export class ListViewComponent implements OnInit {
  ...
  // @ts-ignore
  public wantToListenList: testList[] = [
    {
      id: 0,
  ...
  // fetchTrackDetailsForAllEntries(): void {
  //   const observables = this.itemList.map(item =>
  //     item.spotifyURI ?
  //       this.trackService.findBySpotifyURI(item.spotifyURI).pipe(
  //         catchError(() => of(null)) // Handle fetch errors or not found by returning null
  //       ) :
  //       of(null) // Immediate null for entries without a spotifyURI
  //   );
  //
  //   forkJoin(observables).subscribe(results => {
  //     results.forEach((result, index) => {
  //       const spotifyURI = this.itemList[index].spotifyURI;
  //       if (spotifyURI) {
  //         // Safely updating the map with either track details or null
  //         this.trackDetailsMap[spotifyURI] = result?.body || null;
  //       }
  //     });
  //     // At this point, trackDetailsMap is populated and ready for the template
  //   });
  // }
