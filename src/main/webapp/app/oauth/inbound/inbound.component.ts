...
export class InboundComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let respBody = new StoreResultRequest(this.code, this.state);

    this.http.post<StoreResultResponse>(this.applicationConfigService.getEndpointFor('api/oauth/store-result'), respBody).subscribe({
