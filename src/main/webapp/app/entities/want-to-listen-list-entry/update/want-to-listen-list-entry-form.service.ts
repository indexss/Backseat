...
type WantToListenListEntryFormDefaults = Pick<NewWantToListenListEntry, 'id' | 'addTime' | 'tracks' | 'albums'>;
...
type WantToListenListEntryFormGroupContent = {
  ...
  tracks: FormControl<WantToListenListEntryFormRawValue['tracks']>;
  albums: FormControl<WantToListenListEntryFormRawValue['albums']>;
};
...
export class WantToListenListEntryFormService {
  createWantToListenListEntryFormGroup(
    ...
    return new FormGroup<WantToListenListEntryFormGroupContent>({
      ...
      tracks: new FormControl(wantToListenListEntryRawValue.tracks ?? []),
      albums: new FormControl(wantToListenListEntryRawValue.albums ?? []),
    });
  }
  ...
  private convertWantToListenListEntryToWantToListenListEntryRawValue(
    ...
    return {
      ...
      tracks: wantToListenListEntry.tracks ?? [],
      albums: wantToListenListEntry.albums ?? [],
    };
  }
}
