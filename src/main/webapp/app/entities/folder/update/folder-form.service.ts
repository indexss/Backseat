...
type FolderFormGroupContent = {
  ...
  image: FormControl<IFolder['image']>;
  imageContentType: FormControl<IFolder['imageContentType']>;
...
export class FolderFormService {
  createFolderFormGroup(folder: FolderFormGroupInput = { id: null }): FolderFormGroup {
    ...
    return new FormGroup<FolderFormGroupContent>({
      ...
      image: new FormControl(folderRawValue.image),
      imageContentType: new FormControl(folderRawValue.imageContentType),
