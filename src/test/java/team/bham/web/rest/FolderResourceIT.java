...
class FolderResourceIT {
    ...
    public static Folder createEntity(EntityManager em) {
        Folder folder = new Folder().name(DEFAULT_NAME).image(DEFAULT_IMAGE).imageContentType(DEFAULT_IMAGE_CONTENT_TYPE);
        return folder;
    }
    ...
    public static Folder createUpdatedEntity(EntityManager em) {
        Folder folder = new Folder().name(UPDATED_NAME).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
        return folder;
    }
    ...
    void createFolder() throws Exception {
        ...
        assertThat(testFolder.getImage()).isEqualTo(DEFAULT_IMAGE);
        assertThat(testFolder.getImageContentType()).isEqualTo(DEFAULT_IMAGE_CONTENT_TYPE);
    }
    ...
    void putExistingFolder() throws Exception {
        ...
        updatedFolder.name(UPDATED_NAME).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
        ...
        assertThat(testFolder.getImage()).isEqualTo(UPDATED_IMAGE);
        assertThat(testFolder.getImageContentType()).isEqualTo(UPDATED_IMAGE_CONTENT_TYPE);
    }
    ...
    void fullUpdateFolderWithPatch() throws Exception {
        ...
        partialUpdatedFolder.name(UPDATED_NAME).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
