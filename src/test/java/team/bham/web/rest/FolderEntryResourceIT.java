...
class FolderEntryResourceIT {
    ...
    public static FolderEntry createEntity(EntityManager em) {
        FolderEntry folderEntry = new FolderEntry().spotifyURI(DEFAULT_SPOTIFY_URI).addTime(DEFAULT_ADD_TIME);
        return folderEntry;
    }
    ...
    public static FolderEntry createUpdatedEntity(EntityManager em) {
        FolderEntry folderEntry = new FolderEntry().spotifyURI(UPDATED_SPOTIFY_URI).addTime(UPDATED_ADD_TIME);
        return folderEntry;
    }
    ...
    void putExistingFolderEntry() throws Exception {
        ...
        updatedFolderEntry.spotifyURI(UPDATED_SPOTIFY_URI).addTime(UPDATED_ADD_TIME);
    ...
    void partialUpdateFolderEntryWithPatch() throws Exception {
        ...
        partialUpdatedFolderEntry.addTime(UPDATED_ADD_TIME);
